...
(define (waterjug cA cB g)
  (waterjugHelper 0 0 cA cB g)
  )

(define (waterjugHelper fA fB cA cB g)
  (cond
    [(equal? fB g) (list(list fA fB))]
    [(equal? cB fB) (append (list(list fA fB)) (waterjugHelper fA 0 cA cB g))]
    [(zero? fA) (append (list(list fA fB)) (waterjugHelper cA fB cA cB g))]
    [(> (+ fA fB) cB) (append (list(list fA fB)) (waterjugHelper (modulo (+ fA fB) cB) cB cA cB g))]
    [(<= (+ fA fB) cB) (append (list(list fA fB)) (waterjugHelper 0 (+ fA fB) cA cB g))]
    [else #f]
    )
)