...
(define (p- a b)
  (cond
   [(pz? b) a]
   [(and (not(pz? b)) (pz? a) (error-subtraction))]
   [(p- (pred a) (pred b))]))
...
(define (helper2 a b z)
  (cond
    [(pz? (pred b)) a]
    [(helper2 (p* a z) (pred b) z)]
   ))
